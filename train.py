...
def get_model():
    ...
    dropout_1 = tf.keras.layers.Dropout(0.2)(hidden_1)  # Add dropout here
    hidden_2 = tf.keras.layers.Dense(4, activation='sigmoid')(dropout_1)
    dropout_2 = tf.keras.layers.Dropout(0.2)(hidden_2)
    outputs = tf.keras.layers.Dense(1)(dropout_2)
